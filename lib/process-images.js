...
var imgToSentence = require("./img-to-sentence");
var sentenceToPhraseMap = require("./sentence-to-phrase-map");
var addPhraseMapToGroup = require("./add-phrase-map-to-group");

module.exports = function*(pattern, listOfImages, phraseLength, db){

	var imgPaths = listOfImages.map(function(imgId){
		return path.join(__dirname, "../images", imgId+".jpg");
	});
